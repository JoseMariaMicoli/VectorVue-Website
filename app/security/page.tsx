...
export const metadata: Metadata = {
  title: 'Security',
  description: 'Security information for VectorVue by Nyxera Labs platform and website disclosure scope.'
};
  ...
  return (
    <Container className="py-12 sm:py-16 lg:py-20 3xl:py-24">
      <SectionTitle eyebrow="Security" title="Security Scope and Disclosure Paths">
        Security guidance for VectorVue by Nyxera Labs is separated between platform security and this website repository.
      </SectionTitle>

      <section className="surface-panel mt-10 p-6 sm:p-8">
        <h3 className="text-lg font-semibold">Platform Security</h3>
        <p className="mt-3 text-secondary">
          VectorVue platform security and vulnerability disclosure are managed under Nyxera Labs&apos; coordinated disclosure
          policy.
        </p>
        <p className="mt-3 text-secondary">
      ...
      <section className="surface-panel mt-8 p-6 sm:p-8">
        ...
        <p className="mt-3 text-secondary">
          This repository hosts the public marketing website only. It does not contain production services or customer
          environments.
        </p>
